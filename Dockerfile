...
COPY src/main/gateway/config/global-env.properties /opt/SecureSpan/Gateway/node/default/etc/bootstrap/env/global-env.properties
#COPY src/main/gateway/config/privateKeys /opt/SecureSpan/Gateway/node/default/etc/bootstrap/env/privateKeys
